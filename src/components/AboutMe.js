const AboutMe = () => {
    return (
        <div className="aboutme">
            <div className="about1"><h2>When I'm at home</h2>
                ...
                <img className="image" alt="This is a picture of me waking up in the morning"
                src="https://media.tenor.com/Qy-5rWnTqKAAAAAd/spin-dance.gif"/>
            </div>
            <div className="about2">
                <h2>When I'm not programming at home</h2>
                ...
                <img className="image" alt="This is a dancing monkey"
                src="https://media.tenor.com/I0n7w-UIzycAAAAM/arangutan-monkey.gif"/>
            </div>
        </div>
    )
}
